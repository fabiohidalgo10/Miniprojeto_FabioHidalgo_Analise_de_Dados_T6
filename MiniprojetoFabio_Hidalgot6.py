...
# Análise de Dados com Python [T6]
# Análise Exploratória de Dados (AED) - Base Varejo
# Autor: [Nome do Aluno] - Turma: Analise_de_Dados_T6
# =============================================================================
#
# Objetivo: transformar dados brutos de compras de varejo em informações
# úteis, aplicando as etapas clássicas de um pipeline de ETL/AED:
#   Extração -> Verificação de qualidade -> Limpeza/Transformação ->
#   Estatística descritiva -> Agrupamentos -> Conclusões (insights).
...
def linha(titulo):
    """Imprime um cabeçalho padronizado no terminal para organizar o relatório."""
    print("\n" + "=" * 80)
    print(titulo)
    print("=" * 80)
...
linha("1. CARGA DA BASE E VISÃO GERAL")
...
linha("2. VERIFICAÇÃO DE PROBLEMAS NA BASE (diagnóstico)")
...
linha("4. VALIDAÇÃO DO IDENTIFICADOR DE COMPRA (CO_ID)")
...
linha("5. ESTATÍSTICA DESCRITIVA - Número de filhos do cliente (CL_FHL)")
...
linha("6. AGRUPAMENTO 1 - Vendas (itens) por gênero e categoria de produto")
...
linha("6. AGRUPAMENTO 2 - Vendas (itens) por mês e segmento de cliente (CL_SEG)")
...
linha("6. AGRUPAMENTO 3 (extra) - Top 10 produtos mais vendidos por categoria")
